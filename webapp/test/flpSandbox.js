		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Primeiro App",
									"targetURL": "#comnttdatasaptraining2022mogcaappdemo1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttdatasaptraining2022mogcaappdemo1-display": {
								"semanticObject": "comnttdatasaptraining2022mogcaappdemo1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nttdata.sap.training2022.mog.ca.appdemo1",
									"url": sap.ui.require.toUrl("com/nttdata/sap/training2022/mog/ca/appdemo1")
								}
							}
						}
					}
